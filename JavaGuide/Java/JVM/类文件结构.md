...
![[Pasted image 20240703001309.png]]
...
![[Pasted image 20240703001530.png]]

下面这张图是通过 IDEA 插件 `jclasslib` 查看的，你可以更直观看到 Class 文件结构。
![[Pasted image 20240703001538.png]]
...
类访问和属性修饰符：
![[Pasted image 20240703002049.png]]
...
![[Pasted image 20240703002119.png]]
...
**field info(字段表) 的结构：**
![[Pasted image 20240703002335.png]]
...
**字段的 access_flag 的取值：**
![[Pasted image 20240703002513.png]]
...
**method_info(方法表的) 结构：**
![[Pasted image 20240703002547.png]]

**方法表的 access_flag 取值：**
![[Pasted image 20240703002554.png]]
