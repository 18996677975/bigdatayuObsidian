...
# 什么是虚拟线程
虚拟线程（Virtual Thread）是 JDK实现的轻量级线程(Lightweight Process，LWP），由 JVM 调度。许多虚拟线程共享同一个操作系统线程，虚拟线程的数量可以远大于操作系统线程的数量。
...
![[Pasted image 20240701113403.png]]
